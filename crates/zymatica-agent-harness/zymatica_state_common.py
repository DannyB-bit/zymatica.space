...
Extracted verbatim from zymatica_state.py so the SessionDB mixin modules
(zymatica_state_search / zymatica_state_schema / zymatica_state_portability) can
reference them without importing zymatica_state (which would be a cycle).
zymatica_state re-imports every name here for backward compatibility.
"""
