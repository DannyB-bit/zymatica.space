...
class OptionalSkillSource(SkillSource):
    ...
    ~/.zymatica/skills/ during setup.  They are discoverable via the Skills Hub
    (search / install / inspect) and labelled "official" with "builtin" trust.
    """

    OFFICIAL_REPO = "NousResearch/zymatica"
...
ZYMATICA_INDEX_URL = "https://zymatica.nousresearch.com/docs/api/skills-index.json"
ZYMATICA_INDEX_TTL = 6 * 3600  # 6 hours
...
def _load_hermes_index() -> Optional[dict]:
    ...
    We cache it locally for ZYMATICA_INDEX_TTL seconds to avoid repeated
