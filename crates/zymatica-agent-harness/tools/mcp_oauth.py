...
from zymatica_constants import secure_parent_dir
...
def _get_token_dir(hermes_home: str | Path | None = None) -> Path:
    ...
    Uses ZYMATICA_HOME so each profile gets its own OAuth tokens.
    Layout: ``ZYMATICA_HOME/mcp-tokens/``
    """
...
class HermesTokenStorage:
    ...
    File layout::
        ...
        ZYMATICA_HOME/mcp-tokens/<server_name>.json         -- tokens
        ZYMATICA_HOME/mcp-tokens/<server_name>.client.json   -- client info
        ZYMATICA_HOME/mcp-tokens/<server_name>.meta.json     -- oauth server metadata
    """
    ...
    async def _redirect_handler(authorization_url: str) -> None:
        ...
        if on_ssh and redirect_uri:
            ...
            print(
                ...
                f"\n"
                f"  See: https://zymatica.nousresearch.com/docs/guides/oauth-over-ssh\n",
                file=sys.stderr,
            )
