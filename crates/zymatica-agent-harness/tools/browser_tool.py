...
from zymatica_cli.config import DEFAULT_CONFIG, cfg_get
...
# plugins drop in under ``~/.zymatica/plugins/browser/<vendor>/``.
...
def _resolve_cloud_provider_uncached() -> Optional[CloudBrowserProvider]:
    ...
    browser plugins (``~/.zymatica/plugins/browser/<vendor>/``) participate
        ...
        try:
            ...
            if _requires_real_termux_browser_install(browser_cmd):
                ...
                if _running_in_docker():
                    ...
                    print("       docker pull ghcr.io/nousresearch/zymatica:latest")
                else:
