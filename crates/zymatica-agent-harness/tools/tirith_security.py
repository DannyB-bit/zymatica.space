...
it is automatically downloaded from GitHub releases to $ZYMATICA_HOME/bin/tirith.
...
def _get_hermes_home() -> str:
    """Return the Hermes home directory, respecting ZYMATICA_HOME env var."""
...
def _hermes_bin_dir() -> str:
    """Return $ZYMATICA_HOME/bin, creating it if needed."""
...
def _install_tirith(*, log_failures: bool = True) -> tuple[str | None, str]:
    """Download and install tirith to $ZYMATICA_HOME/bin/tirith.
...
def _resolve_tirith_path(configured_path: str) -> str:
    ...
    2. $ZYMATICA_HOME/bin/tirith (previously auto-installed)
    3. Auto-install from GitHub releases → $ZYMATICA_HOME/bin/tirith
