...
def _action_result_from(
    ...
    *,
    ...
    cua-driver's mcp-tool-notes and NousResearch/zymatica#67052.
    """
...
# fetches the latest release, so a `ZYMATICA_CUA_DRIVER_VERSION` env var would
# only have *looked* like it pinned. For a reproducible version, point
# `ZYMATICA_CUA_DRIVER_CMD` at a specific binary instead.

_CUA_DRIVER_CMD_ENV = "ZYMATICA_CUA_DRIVER_CMD"
...
def _resolve_mcp_invocation(
    ...
    *,
    ...
    Surface 8 of NousResearch/zymatica#47072: instead of hardcoding
...
def _candidate_cua_driver_commands(override: Optional[str] = None) -> List[str]:
    ...
    ``ZYMATICA_CUA_DRIVER_CMD`` is authoritative; only when neither is set do we
...
def resolve_cua_driver_cmd(override: Optional[str] = None) -> Optional[str]:
    ...
    A supplied override (or ``ZYMATICA_CUA_DRIVER_CMD``) is never silently
...
def _parse_elements_from_structured(raw_elements: List[Dict[str, Any]]) -> List[UIElement]:
    """Surface 2 of NousResearch/zymatica#47072: read the canonical
...
class _CuaDriverSession:
    ...
    def __init__(
        ...
        self._started = False
        # Surface 4 of NousResearch/zymatica#47072: per-tool
...
def _extract_tool_result(mcp_result: Any) -> Dict[str, Any]:
    ...
    NousResearch/zymatica#47072). Each entry corresponds index-for-index
...
class CuaDriverBackend(ComputerUseBackend):
    ...
    def __init__(self, permission_mode: str = "standard") -> None:
        ...
        # Surface 6 of NousResearch/zymatica#47072: per-snapshot
    ...
    def capture(
        ...
        # Surface 3 of NousResearch/zymatica#47072: read the canonical
        ...
        if mode == "vision":
            ...
            # Surface 2 of NousResearch/zymatica#47072: prefer the
    ...
    def _apply_delivery(
        ...
        to proceed. See NousResearch/zymatica#67052 phase B.
        """
    ...
    def click(
        ...
        *,
        ...
        # NousResearch/zymatica#47072). cua-driver-rs gained an explicit
