...
# See NousResearch/zymatica#67052 gap 4.
        ...
        with _backend_lock:
            ...
            if cached is not None:
                ...
                backend_name = os.environ.get(
                    "ZYMATICA_COMPUTER_USE_BACKEND", "cua"
                ).lower()
                if backend_name in {"cua", "cua-driver", ""}:
                    ...
                    raise RuntimeError(
                        f"Unknown ZYMATICA_COMPUTER_USE_BACKEND={backend_name!r}"
                    )
...
def _request_approval(action: str, args: Dict[str, Any],
    ...
    silently authorize it (NousResearch/zymatica#67052).
...
def _capture_response(cap: CaptureResult, max_elements: int = _DEFAULT_MAX_ELEMENTS) -> Any:
    ...
    if cap.png_b64 and cap.mode != "ax" and not image_too_small:
        ...
        # parts (Surface 7 of NousResearch/zymatica#47072 — trycua/cua#1961
...
def _route_capture_through_aux_vision(
    ...
    *,
    ...
    The captured base64 PNG is materialised to ``$ZYMATICA_HOME/cache/vision/``
