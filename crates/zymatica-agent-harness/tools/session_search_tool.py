...
the get_anchored_view / get_messages_around primitives in zymatica_state.
...
# Third-party integrations tag their sessions with ZYMATICA_SESSION_SOURCE=tool;
...
def check_session_search_requirements() -> bool:
    ...
    try:
        from zymatica_state import _default_db_path
