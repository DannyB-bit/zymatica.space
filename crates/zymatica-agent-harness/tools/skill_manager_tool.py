...
~/.zymatica/skills/. Existing skills (bundled, hub-installed, or user-created)
...
# All skills live in ~/.zymatica/skills/ (single source of truth)
...
def _skills_dir() -> Path:
    ...
    kanban workers) import this module once under the launch ZYMATICA_HOME and
    ...
    live profile-scoped ZYMATICA_HOME on every call.
    """
...
def _find_skill(name: str) -> Optional[Dict[str, Any]]:
    ...
    Searches the local skills dir (~/.zymatica/skills/) first, then any
...
def _find_skill_in_other_profiles(name: str) -> List[Tuple[str, Path]]:
    ...
    # Default profile (~/.zymatica/skills) — only consider when active is non-default.
    ...
    # All named profiles (~/.zymatica/profiles/*/skills)
...
def _delete_skill(name: str, absorbed_into: Optional[str] = None) -> Dict[str, Any]:
    ...
    # RECOVERABLE: archival into ~/.zymatica/skills/.archive/ is documented as
