"""Central registry for all zymatica tools.
...
def _discovery_cache_path() -> Optional[Path]:
    ...
    try:
        ...
        # import time (zymatica_constants itself is stdlib-only, so no cycle).
...
class ToolRegistry:
    ...
    def __init__(self):
        ...
        # Plugin registrations are overlays keyed by resolved ZYMATICA_HOME. A
