...
from zymatica_constants import display_hermes_home, is_termux as _is_termux_environment
...
class CLICommandsMixin:
    ...
    def _handle_export_command(self, command: str):
        ...
        """
        from zymatica_cli.profiles import export_profile, get_active_profile_name
    ...
    def _handle_journey_command(self, cmd_original: str) -> None:
        ...
        from cli import _cprint
        from zymatica_cli.journey import register_cli
    ...
    def _handle_paste_command(self):
        ...
        from zymatica_cli.clipboard import has_clipboard_image
    ...
    def _handle_copy_command(self, cmd_original: str) -> None:
        ...
        try:
            from zymatica_cli.clipboard import (
    ...
    def _handle_resume_command(self, cmd_original: str) -> None:
        ...
        if target.isdigit():
            ...
            from zymatica_cli.main import _resolve_session_by_name_or_id
    ...
    def _handle_personality_command(self, cmd: str):
        ...
        """
        from zymatica_cli.personality import (
        ...
        if len(parts) > 1:
            ...
            if not name:
                ...
                try:
                    from zymatica_cli.config import cfg_get, read_raw_config
    ...
    def _handle_pet_command(self, cmd: str):
        ...
        from zymatica_cli.pets import _set_active, _set_enabled, print_pet_gallery, set_pet_scale, toggle_pet_display
    ...
    def _handle_hatch_command(self, cmd: str):
        ...
        from zymatica_cli.pets import _set_active
    ...
    def _handle_suggestions_command(self, cmd: str):
        ...
        args = " ".join(tokens)
        try:
            from zymatica_cli.suggestions_cmd import handle_suggestions_command
    ...
    def _handle_blueprint_command(self, cmd: str):
        ...
        try:
            from zymatica_cli.blueprint_cmd import handle_blueprint_command
    ...
    def _handle_curator_command(self, cmd: str):
        ...
        try:
            from zymatica_cli.curator import cli_main
            cli_main(tokens)
        except SystemExit:
    ...
    def _handle_kanban_command(self, cmd: str):
        ...
        """
        from zymatica_cli.kanban import run_slash
    ...
    def _handle_skills_command(self, cmd: str):
        ...
        if args and args[0].lower() in {"pending", "approve", "apply", "reject",
            ...
            from zymatica_cli.write_approval_commands import handle_pending_subcommand
            ...
            if out is not None:
                print(out)
                return
        from zymatica_cli.skills_hub import handle_skills_slash
    ...
    def _handle_init_command(self, cmd: str):
        ...
        """
        from zymatica_cli.init_command import build_init_prompt_for_cwd
    ...
    def _handle_heartbeat_command(self, cmd: str) -> None:
        ...
        from zymatica_cli.heartbeat import parse_interval, format_interval
        ...
        if interval is None:
            ...
            return
        if interval < 0:
            from zymatica_cli.heartbeat import MIN_INTERVAL_SECONDS
    ...
    def _handle_goal_command(self, cmd: str) -> None:
        ...
        from zymatica_cli.goals import parse_contract
    ...
    def _handle_goal_draft(self, objective: str) -> None:
        ...
        from cli import _DIM, _RST, _cprint
        from zymatica_cli.goals import draft_contract
    ...
    def _handle_skin_command(self, cmd: str):
        ...
        try:
            from zymatica_cli.skin_engine import list_skins, set_active_skin, get_active_skin_name
        except ImportError:
    ...
    def _handle_focus_command(self, cmd_original: str) -> None:
        ...
        from zymatica_cli.focus_view import (
            FOCUS_CONFIG_KEY,
    ...
    def _set_tool_progress_mode(self, mode: str) -> None:
        ...
        """
        from zymatica_cli.focus_view import normalize_tool_progress_mode
    ...
    def _note_focus_hidden_line(self, function_name: str) -> None:
        ...
        if not getattr(self, "_focus_view_enabled", False):
            return
        from zymatica_cli.focus_view import would_display_tool_line
    ...
    def _emit_focus_recovery_line(self) -> None:
        ...
        if not getattr(self, "_focus_view_enabled", False):
            return
        from zymatica_cli.focus_view import format_hidden_line
    ...
    def _handle_approvals_command(self, cmd_original: str) -> None:
        ...
        from cli import _cprint
        from zymatica_cli.approval_mode import run_approval_mode_command
    ...
    def _handle_indicator_command(self, cmd: str):
        ...
        """
        from cli import _ACCENT, _DIM, _RST, _cprint, save_config_value
        from zymatica_constants import DEFAULT_INDICATOR_STYLE, INDICATOR_STYLES
    ...
    def _handle_fast_command(self, cmd: str):
        ...
        try:
            from zymatica_cli.models import _is_anthropic_fast_model
            agent = getattr(self, "agent", None)
    ...
    def _handle_debug_command(self, cmd_original: str = ""):
        ...
        """
        from zymatica_cli.debug import run_debug_share
    ...
    def _handle_update_command(self) -> bool:
        ...
        when cancelled.
        """
        from zymatica_cli.config import is_managed, format_managed_message
