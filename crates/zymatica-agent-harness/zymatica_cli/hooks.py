...
Consent records live under ``~/.zymatica/shell-hooks-allowlist.json`` and
hook definitions come from the ``hooks:`` block in ``~/.zymatica/config.yaml``
...
def _cmd_list(_args) -> None:
    ...
    if not specs and not outbound:
        print("No shell hooks or outbound webhooks configured in ~/.zymatica/config.yaml.")
    ...
    if not specs:
        print("No shell hooks configured in ~/.zymatica/config.yaml.")
    else:
