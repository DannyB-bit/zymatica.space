...
Config stored in ~/.zymatica/config.yaml under:
...
from zymatica_cli.config import cfg_get, load_config, save_config
from zymatica_cli.colors import Colors, color
from zymatica_cli.platforms import PLATFORMS as _PLATFORMS
