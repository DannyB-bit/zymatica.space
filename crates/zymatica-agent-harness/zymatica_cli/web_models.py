...
``from zymatica_cli.web_server import ConfigUpdate`` keep working.
"""
...
class ProfileCreate(BaseModel):
    ...
    # because skills_hub.SKILLS_DIR is import-time-bound and the ZYMATICA_HOME
...
class ProfileExport(BaseModel):
    ...
    # Where to write the archive. Empty → a staging path under ZYMATICA_HOME.
    output: str = ""
