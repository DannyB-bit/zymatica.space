...
class CLIBillingMixin:
    ...
    def _print_nous_credits_block(self) -> bool:
        ...
        wall-clock-bounded; honors ZYMATICA_DEV_CREDITS_FIXTURE for offline testing.
        """
    ...
    def _open_url_in_browser(self, url: str) -> bool:
        ...
        if not url:
            return False
        try:
            from zymatica_cli.auth import _can_open_graphical_browser, _is_remote_session
    ...
    def _subscription_preview_and_confirm(self, state, tier_id, *, allow_stepup=True):
        ...
        from zymatica_cli.nous_billing import BillingError, BillingScopeRequired, post_subscription_preview
    ...
    def _subscription_apply(self, state, action, idempotency_key=None, *, allow_stepup=True):
        ...
        from zymatica_cli.nous_billing import (
            BillingError,
            BillingTransient,
    ...
    def _subscription_handle_scope_required(self, state, *, retry, idempotency_key=None):
        ...
        try:
            from zymatica_cli.auth import step_up_nous_billing_scope
        ...
        try:
            from zymatica_cli import nous_billing as _nb
    ...
    def _billing_handle_scope_required(self, state, *, amount=None, idempotency_key=None):
        ...
        from zymatica_cli.nous_billing import BillingError, post_charge
