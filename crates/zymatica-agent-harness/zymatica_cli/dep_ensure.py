...
from zymatica_constants import agent_browser_runnable, find_node_executable
from tools.environments.local import hermes_subprocess_env

_IS_WINDOWS = platform.system() == "Windows"

_DEP_CHECKS = {
    # find_node_executable() rather than a bare which(): $ZYMATICA_HOME/node is
...
def _has_hermes_agent_browser() -> bool:
    ...
    # install.sh installs globally into $ZYMATICA_HOME/node/bin/ via npm -g --prefix
