...
def load_picker_context() -> ConfigContext:
    ...
    """
    from zymatica_cli.config import get_compatible_custom_providers, load_config
...
def build_models_payload(
    ...
    *,
    ...
    """
    from zymatica_cli.model_switch import list_authenticated_providers
    ...
    try:
        from zymatica_cli.providers import is_routing_aggregator as _is_routing_aggregator
    except Exception:
...
def _append_unconfigured_rows(
    ...
    *,
    ...
    from zymatica_cli.models import CANONICAL_PROVIDERS, _PROVIDER_LABELS
...
def _filter_explicit_provider_rows(rows: list[dict], ctx: ConfigContext) -> list[dict]:
    ...
    """
    from zymatica_cli.auth import is_provider_explicitly_configured
...
def _reorder_canonical(rows: list[dict]) -> list[dict]:
    ...
    """
    from zymatica_cli.models import CANONICAL_PROVIDERS
