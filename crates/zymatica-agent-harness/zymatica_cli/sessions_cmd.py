...
def cmd_sessions(args, sessions_parser=None):
    ...
    if action == "recover":
        ...
        from zymatica_cli.session_recovery import (
    ...
    if action == "list":
        ...
        from zymatica_cli.session_filters import (
            build_prune_filters,
            describe_filters,
        )
        ...
        def _redact(data):
            if not args.redact or data is None:
                return data
            from zymatica_cli.session_export_md import redact_session_data
        ...
        if getattr(args, "only", None):
            if args.format not in ("jsonl", "md"):
                ...
                return
            from zymatica_cli.session_export import (
                export_record_count,
        ...
        if args.format == "html":
            if not args.output or args.output == "-":
                ...
                return
            from zymatica_cli.session_export_html import (
        ...
        # Markdown / QMD export
        from zymatica_cli.session_export_md import (
