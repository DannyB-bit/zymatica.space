...
def _install_dependencies(provider_name: str, *, force: bool = False) -> None:
    ...
    # data volume (ZYMATICA_LAZY_INSTALL_TARGET). install_specs handles the
...
def cmd_setup(args) -> None:
    ...
    if not providers:
        ...
        print("  Install a plugin to ~/.zymatica/plugins/ and try again.\n")
        return
...
def cmd_status(args) -> None:
    ...
    if provider_name:
        ...
        if provider:
            ...
            print(f"  Install the '{provider_name}' memory plugin to ~/.zymatica/plugins/")
