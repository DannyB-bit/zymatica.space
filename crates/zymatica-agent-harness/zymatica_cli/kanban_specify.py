...
ZYMATICA_KANBAN_SPECIFY_MAX_TOKENS = max(
    1500,
    env_int("ZYMATICA_KANBAN_SPECIFY_MAX_TOKENS", 6000),
)
...
def _profile_author() -> str:
    ...
    return (
        os.environ.get("ZYMATICA_PROFILE")
    ...
    *,
    ...
    try:
        ...
        resp = call_llm(
            ...
            temperature=0.3,
            max_tokens=ZYMATICA_KANBAN_SPECIFY_MAX_TOKENS,
