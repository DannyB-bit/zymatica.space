...
from zymatica_cli.config import get_env_value, load_config
...
def _has_agent_browser() -> bool:
    ...
    try:
        ...
        # Hermes-managed Node dirs (Windows installer / POSIX $ZYMATICA_HOME/node)
...
def _local_stt_backend_available() -> bool:
    ...
    """
    if get_env_value("ZYMATICA_LOCAL_STT_COMMAND"):
        return True
    try:
    ...
    *,
    ...
    try:
        ...
        local_stt_available = bool(_HAS_FASTER_WHISPER) or bool(
            get_env_value("ZYMATICA_LOCAL_STT_COMMAND")
        )
    except Exception:
        local_stt_available = bool(get_env_value("ZYMATICA_LOCAL_STT_COMMAND"))
...
def prompt_enable_tool_gateway(
    ...
    *,
    ...
    try:
        from zymatica_cli.setup import prompt_checklist
    except Exception:
        return set()
    ...
    if changed:
        from zymatica_cli.config import save_config
