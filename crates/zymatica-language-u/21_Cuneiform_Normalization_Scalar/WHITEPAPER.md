...
Refer to [README.md](../20_Cuneiform_Normalization_Scalar/src/README.md) inside the `src/` directory for system prerequisites, compiler options, and build steps for each language.
