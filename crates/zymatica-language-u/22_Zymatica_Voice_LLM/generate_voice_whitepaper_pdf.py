...
def main():
    ...
    front_cover_path = "language_u_logo.jpg" if os.path.exists("language_u_logo.jpg") else os.path.join(os.path.dirname(os.path.abspath(__file__)), "language_u_logo.jpg")
    ...
    pdf.set_auto_page_break(auto=False)
    pdf.add_page()
    back_cover_path = "Logo.jpg" if os.path.exists("Logo.jpg") else os.path.join(os.path.dirname(os.path.abspath(__file__)), "Logo.jpg")
