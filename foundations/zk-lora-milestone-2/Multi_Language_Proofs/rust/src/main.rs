...
fn main() {
    ...
    let mut v_hash = "8bfa9dfb6d61f1c2ebde915ff7cfd1451f28b4c09ac64b281f5c6c04f9812739".to_string();
    if let Ok(content) = std::fs::read_to_string(file!()) {
        v_hash = simple_sha256(&content);
    }
    let r_sig = simple_sha256(&format!("{}:{}", tx_id, v_hash));
    println!("      Validator Binary Hash: {}...", &v_hash[..32]);
    println!("      Signed Routing Receipt: {}...", &r_sig[..32]);
